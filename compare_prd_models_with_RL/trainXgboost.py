...
DATE = date.today()
EXPERIMENT_NAME = "xgb-anomaly-{0}-1".format(USERNAME)
...
with mlflow.start_run():
    ...
    model = XGBClassifier(use_label_encoder=False, max_depth=10, max_leaf_nodes=10, eval_metric="logloss")
...
EXPERIMENT_NAME = "xgb-anomaly-{0}-2".format(USERNAME)
mlflow.set_experiment(EXPERIMENT_NAME)

with mlflow.start_run():

    model = XGBClassifier(use_label_encoder=False, max_depth=2, max_leaf_nodes=2, eval_metric="logloss")
